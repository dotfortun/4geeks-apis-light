...
<html>
  ...
  <body style="margin: 0">
    ...
    <script src="https://cdn.jsdelivr.net/npm/@scalar/api-reference@1.8.0/dist/browser/standalone.min.js"></script>
    # <script src="https://cdn.jsdelivr.net/npm/@scalar/api-reference@1.13.12/dist/browser/standalone.min.js"></sceript>
  </body>
</html>
"""
    )
